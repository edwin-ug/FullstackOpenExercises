...
sequenceDiagram
    ...
    Note right of browser: Browser executes the JS code to fetch the updated JSON data.
    ...
    Note right of browser: Browser executes the callback function to render the updated notes.
